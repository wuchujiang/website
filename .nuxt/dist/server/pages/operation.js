...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/operation.vue?vue&type=template&id=8c23b2da&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"operation"},[_c('oakHeader',{attrs:{"current":1}}),_vm._ssrNode(" "),_vm._ssrNode("<main>","</main>",[_vm._ssrNode("<section class=\"operation-banner\"></section> <section class=\"saas-tab\"><div class=\"container\">"+(_vm._ssrList((_vm.tab),function(item,index){return ("<div"+(_vm._ssrClass(null,("item " + (_vm.current === index && 'active'))))+">"+_vm._ssrEscape("\n          "+_vm._s(item)+"\n        ")+"</div>")}))+"</div></section> <section class=\"section1\"><div class=\"common-title\"><div class=\"name\">全方位会员体系制定</div> <div class=\"desc\">\n          根据客户需求和产品属性，可针对性地定制输出多种会员体系方案\n        </div></div> <div class=\"operation-list container\"><div class=\"item\"><img"+(_vm._ssrAttr("src",__webpack_require__(81)))+" alt> <p>会员成长体系<br>帮助平台累积忠诚用户</p></div> <div class=\"item\"><img"+(_vm._ssrAttr("src",__webpack_require__(82)))+" alt> <p>会员积分体系<br>帮助平台提高留存及活跃</p></div> <div class=\"item\"><img"+(_vm._ssrAttr("src",__webpack_require__(83)))+" alt> <p>会员权益体系<br>帮助客户增收变现</p></div></div></section> <section class=\"section2 period\"><div class=\"common-title\"><div class=\"name\">用户生命周期管理</div></div> <div class=\"container\"><div class=\"text\"><p>\n            针对性地输出客户权益套餐，满足用户在不同生活场景下的需求，高频使用产品，增加用户黏性，提高用户留存率，进而提升LTV。\n          </p> <p></p> <p>\n            针对客户需要，可以制定的分级式套餐组合，拉动向上销售，提高购买率，从而实现ARPU值提升。\n          </p></div> <img"+(_vm._ssrAttr("src",__webpack_require__(84)))+" alt></div></section> <section class=\"formulate\"><div class=\"common-title\"><div class=\"name\">用户分层及策略制定</div> <div class=\"desc\">\n          多平台整合的销售数据和专业的运营团队，可帮助客户构建用户画像，结合用户标签和消费场景，对用户进行科学化、系统化的分层并制定相应策略。\n        </div></div> <div class=\"container\"><img"+(_vm._ssrAttr("src",__webpack_require__(85)))+" alt class=\"formulate-img\"></div></section> "),_c('oakForm')],2),_vm._ssrNode(" "),_c('oakFooter')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/operation.vue?vue&type=template&id=8c23b2da&
