...
export const key = process.env.NODE_ENV === 'development' ? "203810450" : '203810450';

export const secret = process.env.NODE_ENV === 'development' ? "6qvbhkluygnkm58b49pcphdomh1q5d9o":  "6qvbhkluygnkm58b49pcphdomh1q5d9o";

export const baseUrl = process.env.NODE_ENV === 'development' ? "https://api-stag.xiangshuheika.com" : "https://api-stag.xiangshuheika.com"